...
interface InkRevealProps {
  /** RGB color of the mask overlay, e.g. [8, 8, 10] */
...
export default function InkReveal({
  ...
  // Self-healing loop: re-cover the surface with ink every frame, then carve
  // only the live stamps. When the cursor stops, the trail fades and the
  // mask re-forms on its own.
